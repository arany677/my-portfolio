    ...
    <div className="max-w-4xl space-y-10 animate-in fade-in pb-20">
      ...
      <div className="bg-[#1E293B] p-8 rounded-3xl border border-white/5 shadow-2xl space-y-8">
        {!isAboutPage ? (
          <div className="space-y-6">
            ...
            <div className="pt-8 border-t border-slate-700">
              <h3 className="text-cyan-400 font-bold text-xs uppercase tracking-widest mb-4">
                Social Media Links (Include https://)
              </h3>
          ...
          <div className="space-y-8">
            <div className="flex flex-col md:flex-row items-center gap-8 p-6 bg-[#0F172A] rounded-2xl border border-slate-700">
              ...
              <div className="space-y-3">
                <label className="text-[10px] font-black uppercase text-cyan-400">
                  Update Photo
                </label>
                <label className="cursor-pointer bg-cyan-400 text-[#0F172A] px-6 py-2 rounded-xl font-black text-[10px] hover:opacity-80 block w-fit">
        ...
        <button
          ...
          className="bg-cyan-400 text-[#0F172A] font-black py-4 px-12 rounded-xl uppercase tracking-widest hover:shadow-[0_0_20px_rgba(34,211,238,0.3)] transition-all"
        >
          Save Everything
        </button>
      </div>
...
function Input({ label, value, onChange, placeholder }) {
  return (
    <div className="flex flex-col gap-2 w-full">
      <label className="text-[10px] font-black uppercase text-cyan-400 tracking-widest leading-none ml-1">
        {label}
      </label>
      <input
